-- Combined migrations from @tindeveloper/tinadmin-saas-base
-- Generated: 2025-12-16T19:36:28.509Z
-- 
...
-- 4. 20251204220002_fix_rls_unauthenticated.sql
-- 5. 20251204220003_fix_tenant_insert.sql
-- 6. 20251204220004_fix_function_error.sql
-- 7. 20251204220005_recreate_rls_policies.sql
-- 8. 20251204220006_fix_function_schema_references.sql
-- 9. 20251204220007_disable_rls_for_admin.sql
-- 10. 20251204220008_ensure_function_accessible.sql
-- 11. 20251204220009_fix_rls_for_client_queries.sql
-- 12. 20251204220010_fix_tenant_rls_policy.sql
-- 13. 20251204220011_set_platform_admins_tenant_null.sql
-- 14. 20251204220012_update_rls_for_platform_admins.sql
-- 15. 20251204220013_add_tenant_constraints.sql
-- 16. 20251204220014_create_audit_logs.sql
-- 17. 20251205000000_workspaces_schema.sql
-- 18. 20251205000001_add_workspace_to_audit_logs.sql
-- 19. 20251205000002_user_tenant_roles.sql
-- 20. 20251205120000_update_role_names.sql
-- 21. 20251206000000_add_white_label_settings.sql
-- 22. 20251207000000_create_stripe_tables.sql
-- 23. 20251208000000_create_crm_tables.sql
-- 24. 20251208000001_fix_crm_rls_recursion.sql
-- 25. 20251213000000_fix_rls_recursion.sql
-- 
-- ============================================================
-- START OF MIGRATIONS
-- ============================================================
...
-- ============================================================
-- Migration 1/25: 20251204211105_create_users_tenants_roles.sql
-- ============================================================
...
-- ============================================================
-- Migration 2/25: 20251204220000_tenant_isolation_rls.sql
-- ============================================================
...
-- ============================================================
-- Migration 3/25: 20251204220001_fix_rls_auth.sql
-- ============================================================
...
-- ============================================================
-- Migration 4/25: 20251204220002_fix_rls_unauthenticated.sql
-- ============================================================
...
-- ============================================================
-- Migration 5/25: 20251204220003_fix_tenant_insert.sql
-- ============================================================
...
-- ============================================================
-- Migration 6/25: 20251204220004_fix_function_error.sql
-- ============================================================
...
-- ============================================================
-- Migration 7/25: 20251204220005_recreate_rls_policies.sql
-- ============================================================
...
-- ============================================================
-- Migration 8/25: 20251204220006_fix_function_schema_references.sql
-- ============================================================
...
-- ============================================================
-- Migration 9/25: 20251204220007_disable_rls_for_admin.sql
-- ============================================================
...
-- ============================================================
-- Migration 10/25: 20251204220008_ensure_function_accessible.sql
-- ============================================================
...
-- ============================================================
-- Migration 11/25: 20251204220009_fix_rls_for_client_queries.sql
-- ============================================================
...
-- ============================================================
-- Migration 12/25: 20251204220010_fix_tenant_rls_policy.sql
-- ============================================================
...
-- ============================================================
-- Migration 13/25: 20251204220011_set_platform_admins_tenant_null.sql
-- ============================================================
...
-- ============================================================
-- Migration 14/25: 20251204220012_update_rls_for_platform_admins.sql
-- ============================================================
...
-- ============================================================
-- Migration 15/25: 20251204220013_add_tenant_constraints.sql
-- ============================================================
...
-- ============================================================
-- Migration 16/25: 20251204220014_create_audit_logs.sql
-- ============================================================
...
-- ============================================================
-- Migration 17/25: 20251205000000_workspaces_schema.sql
-- ============================================================
...
-- ============================================================
-- Migration 18/25: 20251205000001_add_workspace_to_audit_logs.sql
-- ============================================================
...
-- ============================================================
-- Migration 19/25: 20251205000002_user_tenant_roles.sql
-- ============================================================
...
-- ============================================================
-- Migration 20/25: 20251205120000_update_role_names.sql
-- ============================================================
...
-- ============================================================
-- Migration 21/25: 20251206000000_add_white_label_settings.sql
-- ============================================================
...
-- ============================================================
-- Migration 22/25: 20251207000000_create_stripe_tables.sql
-- ============================================================
...
-- ============================================================
-- Migration 23/25: 20251208000000_create_crm_tables.sql
-- ============================================================
...
-- ============================================================
-- Migration 24/25: 20251208000001_fix_crm_rls_recursion.sql
-- ============================================================
...
-- ============================================================
-- Migration 25/25: 20251213000000_fix_rls_recursion.sql
-- ============================================================
